        ...
        <div className="info-container">
            ...
            <div className="info-details">
                <div className="info-details-box">
                    <h3>Sobre <AiOutlineArrowDown className='info-details-box-arrow' style={iconeAtual ? {transform: "rotate(-180deg)"}:{}} onClick={toogleInfo}/> </h3>
                ...
                <div className="info-details-box">
                    <h3>Porque deveria me contratar <AiOutlineArrowDown className='info-details-box-arrow' style={iconeAtual2 ? {transform: "rotate(-180deg)"}:{}} onClick={toogleInfo2} /></h3>
